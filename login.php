...
if(isset($_SESSION['logged_in']) && $_SESSION['logged_in'] == true && isset($_SESSION['location'])){
    header('Location: index.php');
}else{
    if(isset($_COOKIE['why'])){
    $errors['why']=$_COOKIE['why'];
    setcookie('why',"",time()-10);
    }
?>
<!DOCTYPE html>
<html lang="en">
...
<section class="register">
    <div class="content">
                <form action="login.php" method="POST" autocomplete="" class="login-form">
                    ...
                    <p><a style="font-size: 1.8rem;" href="forgot-password.php">Forgot password?</a><br/>
                        Not yet a member? <a href="register.php">Signup now</a></p>
                </form>
    </div>
</section>
