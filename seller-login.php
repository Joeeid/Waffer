...
if(isset($_POST['loginseller'])){
	...
	if(mysqli_num_rows($res) > 0){
		...
		if(md5($password)==$fetch_pass){
				...
				$_SESSION['mid'] = $mid;
			  	$_SESSION['logged_in_seller']=true;
				header('location: seller.php');
		}else{
			$errors['email'] = "Incorrect email or password!";
		}
	}else{
		$errors['email'] = "It's look like you're not yet a seller! Contact us for more info.";
	}
}
...
<section class="register">
    <div class="content">
                <form action="seller-login.php" method="POST" autocomplete="" class="login-form">
                    ...
                    ?>
                        ...
                        <input class="btn" type="submit" name="loginseller" value="Login"><br/>
                        <p>
                    <!-- <a style="font-size: 1.8rem;" href="forgot-password.php">Forgot password?</a><br/> -->
                        Not a Seller? <a href="login.php">Login as user</a></p>
                </form>
    </div>
</section>
