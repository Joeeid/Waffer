...
<header class="header">
    ...
    <div class="content">
                <form action="user-otp.php" method="POST" autocomplete="off" class="login-form">
                    ...
                    ?>
                        <input class="box" type="number" name="otp" placeholder="Enter verification code" required>
